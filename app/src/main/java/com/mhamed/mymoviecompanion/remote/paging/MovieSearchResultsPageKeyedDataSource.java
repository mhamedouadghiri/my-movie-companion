...
public class MovieSearchResultsPageKeyedDataSource extends PageKeyedDataSource<Integer, Movie> {
    ...
    public MovieSearchResultsPageKeyedDataSource(String query) {
        this.query = query;
    }
    ...
    public void loadInitial(@NonNull final LoadInitialParams<Integer> params, @NonNull final LoadInitialCallback<Integer, Movie> callback) {
        ...
        Call<MoviesResponse> request = movieService.searchMoviesByTitle(query, FIRST_PAGE);
    ...
    public void loadAfter(@NonNull final LoadParams<Integer> params, @NonNull final LoadCallback<Integer, Movie> callback) {
        ...
        Call<MoviesResponse> request = movieService.searchMoviesByTitle(query, params.key);
