...
public class RecommendationClient {
    ...
    public static class Result {
        ...
        public String toString() {
            return String.format(Locale.FRANCE, "[%d] confidence: %.3f, item: %s", id, confidence, item);
        }
    }
    ...
    synchronized Object[] preprocess(List<MovieItem> selectedMovies) {
        ...
        sortedFeatures.sort((Config.Feature a, Config.Feature b) -> Integer.compare(a.index, b.index));
