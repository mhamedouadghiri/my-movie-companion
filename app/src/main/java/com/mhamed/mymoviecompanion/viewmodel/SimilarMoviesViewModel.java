...
public class SimilarMoviesViewModel extends BaseViewModel {

    private static final int PAGE_SIZE = 20;

    private final LiveData<PagedList<Movie>> pagedList;
    private final LiveData<Resource> networkState;
    private final SimilarMoviesDataSourceFactory sourceFactory;

    public SimilarMoviesViewModel(Long movieId) {
        Executor executor = Executors.newFixedThreadPool(5);

        sourceFactory = new SimilarMoviesDataSourceFactory(movieId);
